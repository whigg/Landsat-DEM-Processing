...
DzipOut = 'ZipImg/'
#####################################################################################
# Open shapefiles and prep geopandasdataframe
...
##################################################################################
# Store useable code that is omitted
# Store useable code that is omitted

# # # Check metadata info
# MetShape = 'C:/Users/WindowShop/Documents/GitHub/LD/Metadata/Metadata_LiDAR_JamesRiver_Ph4_QL3/Metadata_LiDAR_JamesRiver_Ph4_QL3/Block_T-723/Shapefiles'

# file4 = MetShape+'/'+'Block_T_Hydro.shp'

# file4 = gpd.read_file(file4)
# # print file4
# plt.show(file4.plot(column='Type', legend=True))
# sys.exit()

#######################################
# This will write a crude csv file    #
# from a given kmz file. Very raw data#
#######################################

# Open and process kmz files

### Writes a crude csv file used online converter instead

# from zipfile import ZipFile

# filename = 'LakeSak.kmz'
